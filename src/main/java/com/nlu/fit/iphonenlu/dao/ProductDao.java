...
public interface ProductDao extends JpaRepository<Product, Integer> {
	...
	@Query("SELECT new ReportCategory(o.category.Category_id,o.category.name, sum(o.Unit_price), count(o)) "
			+ " FROM Product o " + " GROUP BY o.category.Category_id ,o.category.name"
	...
	@Query("SELECT new ReportTrademark(o.trademark.Trademark_id,o.trademark.name, sum(o.Unit_price), count(o)) "
			+ " FROM Product o " + " GROUP BY o.trademark.Trademark_id ,o.trademark.name"
			+ " ORDER BY sum(o.Unit_price) DESC")
	...
	List<Product> findByAllKeyWord(@Param("MinPrice") Integer unit_price, @Param("MaxPrice") Integer unit_price1,
			@Param("Category_id") String Category_id, @Param("Trademark_id") String Trademark_id,
			@Param("Ram") String Ram, @Param("Rom") String Rom, @Param("Resolution") String Resolution);
